              ...
              <StaggerContainer className="grid md:grid-cols-3 gap-4">
                <StaggerItem>
                  <div className="border rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Trẻ 3-5 tuổi</p>
                  </div>
                </StaggerItem>
                <StaggerItem>
                  <div className="border rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Trẻ 6-8 tuổi</p>
                  </div>
                </StaggerItem>
                <StaggerItem>
                  <div className="border rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Trẻ 9-12 tuổi</p>
                  </div>
                </StaggerItem>
              </StaggerContainer>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <ol className="list-decimal list-inside space-y-3 text-muted-foreground">
                <li>
                  <span className="font-medium text-foreground">Tải ứng dụng ARTEMIS</span>{" "}
                ...
                <li>
                  <span className="font-medium text-foreground">Hoàn tất!</span> Bắt đầu theo dõi con yêu
                </li>
              </ol>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  → Đảm bảo ở ngoài trời, tránh nhà cao tầng. Đợi 2-3 phút để bắt tín hiệu
                </p>
              </div>
            </CardContent>
          </Card>
